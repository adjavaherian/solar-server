...
void SolarCamera::setup() {
  ...
  if (temp != 0x55) {
    ...
    // uncomment for Auto
    myCAM.wrSensorReg8_8(0xc7, 0x01);  //AWB on

    // uncomment for cloudy
    // myCAM.wrSensorReg8_8(0xc7, 0x40); //AWB off
    // myCAM.wrSensorReg8_8(0xcc, 0x65);
    // myCAM.wrSensorReg8_8(0xcd, 0x41);
    // myCAM.wrSensorReg8_8(0xce, 0x4f);


    // uncomment for sunny
    // myCAM.wrSensorReg8_8(0xc7, 0x40); //AWB off
    // myCAM.wrSensorReg8_8(0xcc, 0x5e);
    // myCAM.wrSensorReg8_8(0xcd, 0x41);
    // myCAM.wrSensorReg8_8(0xce, 0x54);
